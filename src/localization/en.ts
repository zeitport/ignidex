...
export const hints = {
    ...
    iconStyleNone: '[LMB] Use original icon colors',
    iconStyleMask: '[LMB] Use monochrome (mask) icon',
    iconStyleMaskAccent: '[LMB] Use accent colored icon',
    ...
    cardSectionTitle: '[RMB] Open section menu',
    cardGroupTitle: '[RMB] Open group menu',
}
