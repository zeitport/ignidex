...
- Duplicate panel action
- Internationalization (i18n) support
- Keyboard shortcuts (F1 for settings, arrow keys navigation)
- Show icons in switch panel overlay
- Remote badge indicator for shared panels
- Move group left/right
- Settings icon button
- Getting started guide with easter egg
...
- New header style with hover effects
